import { n as noop, c as create_ssr_component, a as add_attribute, v as validate_component, b as subscribe, d as assign, i as identity, o as onDestroy, m as missing_component, e as each, f as escape, g as null_to_empty } from "../../chunks/ssr.js";
...
const Notification_svg = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { class: className = "" } = $$props;
  if ($$props.class === void 0 && $$bindings.class && className !== void 0)
    $$bindings.class(className);
  return `<svg${add_attribute("class", className, 0)} width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="iconamoon:notification-bold"><g id="Group"><path id="Vector" d="M6 19.5V10.5C6 8.9087 6.63214 7.38258 7.75736 6.25736C8.88258 5.13214 10.4087 4.5 12 4.5C13.5913 4.5 15.1174 5.13214 16.2426 6.25736C17.3679 7.38258 18 8.9087 18 10.5V19.5M6 19.5H18M6 19.5H4M18 19.5H20M11 22.5H13" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path><path id="Vector_2" d="M12 4.5C12.5523 4.5 13 4.05228 13 3.5C13 2.94772 12.5523 2.5 12 2.5C11.4477 2.5 11 2.94772 11 3.5C11 4.05228 11.4477 4.5 12 4.5Z" stroke="white" stroke-width="2.5"></path></g></g></svg>`;
});
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="flex w-full justify-between h-16 bg-primary p-4"><button>${validate_component(Image_svg, "Image").$$render($$result, { class: "h-8" }, {}, {})}</button> <div>${validate_component(Notification_svg, "Notification").$$render($$result, {}, {}, {})}</div> </header>`;
});
const nprogress = "";
const nprogress_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: "#nprogress .bar{height:0.5rem;--tw-bg-opacity:1;background-color:rgb(130 180 133 / var(--tw-bg-opacity))\n}#nprogress .bar .peg{display:none\n}",
  map: null
};
const delay = 250;
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${data.session === null ? `${slots.default ? slots.default({}) : ``}` : `${validate_component(Header, "Header").$$render($$result, {}, {}, {})} ${slots.default ? slots.default({}) : ``}`} ${validate_component(SvelteToast, "SvelteToast").$$render($$result, {}, {}, {})} ${validate_component(Nprogress, "Nprogress").$$render($$result, {}, {}, {})}`;
});
export {
  Layout as default
};
